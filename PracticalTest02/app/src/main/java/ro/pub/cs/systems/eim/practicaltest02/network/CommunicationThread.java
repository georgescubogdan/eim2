    ...
    public void run() {
        ...
        try {
            ...
            if (data.containsKey(city)) {
                ...
                Log.e(Constants.TAG, "[COMMUNICATION THREAD] received data: " + document);

                Element element = document.child(0);
                Log.e(Constants.TAG, "[COMMUNICATION THREAD] received data: " + element);
                Elements elements = element.getElementsByTag(Constants.SCRIPT_TAG);
                Log.e(Constants.TAG, "[COMMUNICATION THREAD] received data: " + elements);
